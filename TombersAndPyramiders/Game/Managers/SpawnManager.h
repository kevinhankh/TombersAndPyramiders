...
public:
	...
	std::shared_ptr<Spikes> generateSpikes(float x, float y); 
	std::shared_ptr<DartTrap> generateDartTrap(float x, float y, DartTrap::Direction direction);
	...
	std::shared_ptr<Throne> generateThrone(float x, float y);
